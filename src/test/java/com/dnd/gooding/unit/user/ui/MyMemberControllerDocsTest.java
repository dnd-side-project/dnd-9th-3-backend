...
class MyMemberControllerDocsTest {
    ...
    @InjectMocks private MyMemberController myMemberController;
    ...
    void beforeEach() {
        ...
        myMemberController =
                new MyMemberController(memberQueryService, updateMemberUseCase, logoutTokenUseCase);
    }
    ...
    void member(RestDocumentationContextProvider contextProvider) throws Exception {
        ...
        MockMvcFactory.getRestDocsMockMvc(contextProvider, HOST_LOCAL, myMemberController)
                .perform(
                        RestDocumentationRequestBuilders.post("/api/v1/my/member")
