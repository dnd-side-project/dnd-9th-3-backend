...
public class Record {
    ...
    public Record(RecordNo number, Coordinate coordinate,
          Recorder recorder, String title, String description, RecordState state, long recordScore,
          LocalDateTime recordDate, List<Image> images) {
        setNumber(number);
